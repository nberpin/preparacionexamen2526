...
Además en el fichero: style-guide.md el diseñador nos ha dejado los colores y otros requisitos que hay que leer para que luego nos paguen.
...
https://github.com/nberpin/preparacionexamen2526
...
- **Motivo de uso:**
    -  Esta sección es el padre de todas las secciones del proyecto por eso en la hoja de estilo vamos a poner que es donde activamos el flex con:
